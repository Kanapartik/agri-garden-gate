...
Version `0.2.3` retains the supplied Agrivah lockup and app icon and updates the
device-local synthetic profile to the web farmer snapshot captured on 1 September
2026. The app requests
...
- Record baseline consent through the server-signed consent endpoint; v0.2.3
