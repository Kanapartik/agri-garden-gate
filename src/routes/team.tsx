      ...
      <section className="bg-surface-deep text-surface-deep-foreground">
        <div className="mx-auto w-full max-w-6xl px-6 py-16 sm:py-20">
          ...
          <p className="mt-5 max-w-2xl text-sm leading-relaxed opacity-85 sm:text-base">
            Agrivah brings together agriculture research, FPO and value-chain experience, enterprise
            technology delivery, agribusiness consulting, incubation, entrepreneurship development
