...
const en: Dict = {
  ...
  "nav.farm": "My farm",
  "nav.farmHistory": "My farm history",
  ...
  "fpo.title": "FPO workspace",
  "fpo.description":
    "Run the organization: profile and compliance, farmer membership, opportunities and operations. Membership never grants access to a farmer's private farm data.",
  "fpo.section.overview": "Dashboard",
  "fpo.section.settings": "Organization profile",
  "fpo.section.documents": "Documents & compliance",
  "fpo.section.farmers": "Farmer membership",
  ...
  "fpo.section.billing": "Billing & collections",
    "fpo.section.monitoring": "Field monitoring",
    "fpo.section.benchmark": "FPO comparison",
...
const te: Dict = {
  ...
  "nav.farmHistory": "నా వ్యవసాయ చరిత్ర",
...
const hi: Dict = {
  ...
  "nav.farm": "मेरा खेत",
  "nav.farmHistory": "मेरे खेत का इतिहास",
...
const ta: Dict = {
  ...
  "nav.farm": "எனது நிலம்",
  "nav.farmHistory": "எனது நிலப் பயிர் வரலாறு",
...
const kn: Dict = {
  ...
  "nav.farm": "ನನ್ನ ಹೊಲ",
  "nav.farmHistory": "ನನ್ನ ಹೊಲದ ಇತಿಹಾಸ",
...
export const DICTIONARIES: Record<Locale, Dict> = {
  en: { ...PAGE_DICTS.en, ...PAGE_DICTS_2.en, ...PAGE_DICTS_3.en, ...FPO_PORTAL_DICTS.en, ...en },
  te: { ...PAGE_DICTS.te, ...PAGE_DICTS_2.te, ...PAGE_DICTS_3.te, ...FPO_PORTAL_DICTS.te, ...te },
  hi: { ...PAGE_DICTS.hi, ...PAGE_DICTS_2.hi, ...PAGE_DICTS_3.hi, ...FPO_PORTAL_DICTS.hi, ...hi },
  ta: { ...PAGE_DICTS.ta, ...PAGE_DICTS_2.ta, ...PAGE_DICTS_3.ta, ...FPO_PORTAL_DICTS.ta, ...ta },
  kn: { ...PAGE_DICTS.kn, ...PAGE_DICTS_2.kn, ...PAGE_DICTS_3.kn, ...FPO_PORTAL_DICTS.kn, ...kn },
};
