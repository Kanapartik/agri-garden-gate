...
export const FPO_SECTION_DEFS: SectionDef[] = [
  ...
  { key: "monitoring", label: "Field monitoring", labelKey: "fpo.section.monitoring", phase: 14 },
  { key: "benchmark", label: "FPO comparison", labelKey: "fpo.section.benchmark", phase: 14 },
...
export const DELIVERED_PHASES = 14;
